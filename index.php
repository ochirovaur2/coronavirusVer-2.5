...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Ежедневная статистика по распространению Коронавируса"/>
    <meta name="keywords" content="коронавирус, covid-2019, вирус, вирусы">
    <meta name="yandex-verification" content="fae85c622de0bb3a" />
    <meta name='wmail-verification' content='44eedd4cceea8058207556d5eef84264' />
    <meta name="google-site-verification" content="E0uijVQC7IqyARNphKcfQR5qIj9Nk0BZBK1oNtfkb6I" />
  ...
  <body>
    ...
    <main class="main">
      ...
      <section class="summaryRussia section " id="yak1"> 
        ...
        <p class="paragraph my-b-normal u-center-text paragraph__table">Данные обновлены: 17 марта 2020, 22:00:00 </p>
        <div class="container summaryRussia__container" id="summaryRussia">
          <div class="summaryRussia__card">
			<h3 class="heading-tertiary">Проведено исследований на коронавирус</h3>
			<p class="paragraph__icu paragraph">116 061</p>
		  </div>
        </div>
        ...
        <div class="container">
          <table class="table" id="tableSortRussia">
            <thead>
              <tr>
      ...
      <section class="section">
        <div class="container">
          <table class="table" id="tableSortChina">
            <thead>
    ...
    <footer class="footer">
      <div class="container main-footer">
        <p class="paragraph paragraph__footer my-b-normal">Ochirov Aiur 2020 <a href="version.html" class="footer__site-version">Ver. 2.4</a></p>
        <div class="social">
      ...
      <div class="container footer__second">
        ...
        <div>
            ...
            <a href="https://rospotrebnadzor.ru/" class="footer__site-version">Роспотребнадзор</a>
